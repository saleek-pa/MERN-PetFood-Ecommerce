      ...
      <MDBFooter className="footer-color text-center text-lg-start text-white" id="contact">
        <section className="footer-position">
          <MDBContainer className="text-center text-md-start">
            <MDBRow className="">
              ...
              <MDBCol
                ...
                lg="2"
                xl="2"
                className="contact-hover text-secondary mx-auto mb-4"
              >
              ...
              <MDBCol
                ...
                lg="2"
                xl="2"
                className="contact-hover text-secondary mx-auto mb-md-0 mb-4"
              >
          ...
          <div className="payment d-flex justify-content-between align-items-center flex-wrap pe-5 me-5 ps-5 ms-5 pb-4">
            ...
            <img
              src="https://codewithsadee.github.io/kitter/assets/images/payment.png"
              alt="asd"
            />
          </div>
        </section>
